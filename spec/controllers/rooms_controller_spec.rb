  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved room as @room" do
        ...
        post :create, {:room => { "building" => "invalid value" }}, valid_session
        assigns(:room).should be_a_new(Room)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested room" do
        ...
        Room.any_instance.should_receive(:update_attributes).with({ "building" => "1" })
        put :update, {:id => room.to_param, :room => { "building" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the room as @room" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Room.any_instance.stub(:save).and_return(false)
        put :update, {:id => room.to_param, :room => { "building" => "invalid value" }}, valid_session
        assigns(:room).should eq(room)
      end
